  ...
  return (
    <div className="panel" style={{ display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "13px 20px", borderTop: "1px solid var(--line)", display: "flex", justifyContent: "space-between", fontSize: "11px", fontFamily: "JetBrains Mono", color: "var(--ink-faint)", flexWrap: "wrap", gap: "8px" }}>
        {cats.map(function (c) {
          return <span key={c.key}>{c.key}&nbsp;CPA&nbsp;<b style={{ color: c.tone }}>{c.chats > 0 ? formatLKR(c.cpa) : "—"}</b></span>;
        })}
      </div>
    </div>
  );
...
export function BudgetPlanner(props) {
  const [strat, setStrat] = useState("current");
    ...
    <div className="panel" style={{ display: "flex", flexDirection: "column" }}>
      ...
      <div style={{ padding: "18px 20px", flex: 1 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: "18px" }}>
          ...
          <span className="mono" style={{ fontSize: "13px", fontWeight: 700, color: "var(--accent-bright)", whiteSpace: "nowrap" }}>{formatLKR(budget)}</span>
        </div>
        ...
        <div className="sim-out">
          ...
          <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginTop: "12px", gap: "12px" }}>
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <div className="mono" style={{ fontSize: "14px", fontWeight: 700, color: "var(--ink)", marginTop: "6px", whiteSpace: "nowrap" }}>{formatLKR(m.cpa)}</div>
